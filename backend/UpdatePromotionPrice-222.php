...
<?php
	...
	if($objConnect)
	{
		...
		{ 
           ...
           $strSQL = "INSERT INTO `jenbunjerd_productdiscount` (`discountlist_id`, `products_id`, `quantity`, `products_discountprice`, `date_start`, `date_end`) VALUES (NULL, '$data1',1, '$data3', DATE('$data4'), DATE('$data5'))";     
